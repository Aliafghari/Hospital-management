                                        ...
                                        <div class="mx-auto" style="width: 140px;">
                                            <div class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239);">
                                                <form action="/upload" method="POST" enctype="multipart/form-data">
                                                    <span style="color: rgb(166, 168, 170); font: bold 8pt Arial;"><img src="<?php echo 'http://localhost:8080' . "/uploads/" . $data[0]['url_picture'] ?>" class="rounded" alt="not load" width='140px' height="140">140*140</span>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                        <form class="form" action="" method="POST" enctype=' multipart/form-data'>
                                            <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                <h4 class="text-nowrap" style="font-size:50px ;"><?php echo $data[0]['firstName'] . ' ' . $data[0]['lastName'] ?></h4>
                                                <div class="mt-2">
