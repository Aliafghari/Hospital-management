                ...
                <div class="profile-img">
                    <img style="width:240px ;height:240px " src="<?php
                                                                    if (!empty($data[0]['url_picture'])) {
                                                                        echo 'http://127.0.0.1:8080' . "/uploads/" . $data[0]['url_picture'];
                                                                    } else {
                                                                        echo '../uploads/img_profile/avatar7.png';
                                                                    }
                                                                    ?>" alt="" />
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="menu2" role="tabpanel">
                        ...
                        <div class="row">
                            <p style="color:red ;">social media</p>
                            <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
                                ...
                                </svg> <a href="https://web.telegram.org/">Telegram</a></p></br>
                            <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                                ...
                                </svg> <a href="https://twitter.com/">Twitter</a></p></br>
                            <p> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                                ...
                                </svg> <a href="https://www.instagram.com/">Instagram</a></p></br>
                        </div>
