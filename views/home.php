...
?>
  <section class="hero" id="hero">
    <div><img class="img-fluid" src="../uploads/img_profile/123.jpg"  alt="" style="width:1500px ; height:400px;">
    <div class="heroText d-flex flex-column justify-content-center">
      <h1 class="mt-auto mb-2">
        به سیستم مدیریت بیمارستان خوش آمدید
      </h1>
      <p class="mb-4">
...
<?php } else {  ?>
  <section class="hero" id="hero">
    <div class="heroText d-flex flex-column justify-content-center">
      ...
      <img class="img-fluid" src="../uploads/img_profile/456.jpg"  alt="" style="width:1500px ; height:400px;">
        <?php //echo $_SESSION['massage'];
        echo 'Welcome  '.$data[0]['firstName']; ?>
      </h3>
  </section>
<?php } ?>
<?php if (isset($_SESSION['id'])) {
